...
v2.0.0 面向 50 人以上、项目和比赛并行、成员频繁变动的真实团队场景，统一项目、任务、比赛、贡献、排序异议、灵活工时、敏感资料、经费、文件、知识产权、通知和报表流程。发布状态以自动化测试与演示验收结果为准，不再使用历史功能清单推断完成度。
...
- **v2.0.0**:当前版本(2026-07-26,团队工作台、账户偏好、OCR、演示备份、定时报表与实时通知)
- **后续版本**:代码分割、性能调优及按实际配置启用的第三方集成
